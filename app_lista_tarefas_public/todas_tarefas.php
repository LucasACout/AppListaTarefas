	...
	<head>
		...
		<script>
			...
			function editar(id, txt_tarefa){
				...
				//Inserir elemento dentro de outro que já existe [mais ou menos isso]
						...
						<div class="row">
							<div class="col">
								...
								<div class="row mb-3 d-flex align-items-center tarefa">
									<div class="col-sm-9" id="tarefa_<?= $valor->id ?>"><?= $valor->tarefa ?> (<?= $valor->status ?>)</div>
									<div class="col-sm-3 mt-2 d-flex justify-content-between">
										...
										<i class="fas fa-check-square fa-lg text-success" onclick="realizada(<?= $valor->id ?>)"></i>
